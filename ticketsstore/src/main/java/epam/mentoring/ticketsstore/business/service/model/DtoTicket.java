...
public class DtoTicket implements Serializable {
    ...
    public DtoTicket(Ticket ticket) {
        ...
        this.sitPlace = ticket.getSitPlace();
        this.buyerID = ticket.getBuyerID();
        this.sellerID = ticket.getBuyerID();
        this.isSold = ticket.isSold();
        this.purchaseDateTime = ticket.getPurchaseDateTime().toInstant(ZoneOffset.UTC).toEpochMilli();
        this.validationCode = ticket.getValidationCode();
    }
